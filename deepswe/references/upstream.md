...
The KVV DeepSWE section specifies Pier and Kimi Code 0.23.6 or newer. It does not define a universal DeepSWE sampling profile. Record actual request settings instead of importing temperature or top-p values from another KVV benchmark table.
